      ...
      <div>
        <div className="home-wrapper">
          <form className="home-container1">
            <div className="home-paragraph1">
              ...
              <p>
                ...
                <br></br> sed do eiusmod tempor incid alor the old familer olfre
              ...
              <div className="home-search">
                <input
                  ...
                  type="text"
                  placeholder="Enter a Street, State, Zip or keyword"
                />
                <div>
            ...
            <div className="home-paragraph2">
              <img
                src="https://elementor1.contempothemes.com/wp-content/uploads/2020/12/2-1-1536x967.jpg"
                alt="image_not_working"
              />
            </div>
          </form>
          ...
          <div className="home-mid-pargra">
            ...
            <p>
              ...
              ellt dolore magna the alora aliqua.
            </p>
          </div>
          ...
          <div className="home-communities">
            ...
            <p>
              ...
              sed do eiusmod tempor incid idunt ut labore ellt dolore<br></br>{" "}
              magna the alora aliqua alora the tolda on fouter.
            </p>
          </div>
        </div>
        <br></br>
        ...
        <div className="home-mid2-paragraph">
          <div className="home-mid-block1">
            <p>Blair Owens</p>
            <h4>
              A Real Estate Agency Leading The Luxury Properties Market
          ...
          <div className="home-mid-block2">
            <p>
              ...
              gravida tortor semper nibh vehicula, in tempor urna dignissim.
        ...
        <div className="home-mid-cards">
          ...
          <div className="mid-card3">
            <h3>Tailormade End-To-End Service</h3>
            <br></br>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin
              gravida tortor semper nibh vehicula, in tempor urna dignissim.
        ...
        <div className="home-bottom">
          ...
          <section className="bottom-section">
            <div>
              ...
              <h4>
                SELL YOUR PROPERTY <br></br>THROUGH BLAIR OWENS
              </h4>
            </div>
          ...
          <form className="home-testimonial">
            ...
            <div className="home-testimonial-wrapper">
              <div className="client-block1">
                <img
                  className="client-img-home"
                  src="https://elementor1.contempothemes.com/wp-content/uploads/2020/12/home-slide-3-2.jpg"
                  alt="not_found"
                />
              </div>
              <div className="client-block2">
                <p>
                  `“I couldn't be more impressed with the team at Blair Owens,
                  they found my family our perfect dream home. True
                  professionals from knowledge of the area, to the closing
                  process and everything else in between — thank you!”`
                </p>
                <h5>The Family</h5>
                <img
